...
module.exports = (sequelize) => {
  const Employee = sequelize.define('Employee', {
    ...
    empresa_principal: { type: DataTypes.INTEGER },
    ...
    lugar_emision_dpi: { type: DataTypes.STRING },
    ...
    irtra: { type: DataTypes.DECIMAL(11, 2), defaultValue: 0 },
    intecap: { type: DataTypes.DECIMAL(11, 2), defaultValue: 0 },
    isr: { type: DataTypes.DECIMAL(11, 2), defaultValue: 0 },
    otro_descuentos: { type: DataTypes.DECIMAL(11, 2), defaultValue: 0 },
    otros_egresos: { type: DataTypes.DECIMAL(11, 2), defaultValue: 0 },
    ...
    tipo_planilla: { type: DataTypes.STRING },
