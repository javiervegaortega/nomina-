  ...
  return (
    <Box p={{ base: 3, md: 6, lg: 8 }}>
      ...
      <Box bg={tableContainerBg} borderRadius="2xl" border="1px solid" borderColor={tableBorderColor} overflow="hidden" boxShadow="sm">
        <Flex p={4} borderBottom="1px solid" borderColor={tableBorderColor} bg={useColorModeValue('gray.50', 'whiteAlpha.50')}>
        ...
        <Box overflowX="auto">
          <Table variant="simple">
            <Thead bg={useColorModeValue('gray.50', 'blackAlpha.300')}>
              <Tr>
                <Th>ID</Th>
                <Th>Nombre</Th>
                <Th>Correo</Th>
            ...
            <Tbody>
              {isLoading ? (
                ...
                filteredUsers.map(u => (
                  <Tr key={u.id} _hover={{ bg: useColorModeValue('gray.50', 'whiteAlpha.50') }} transition="background 0.2s">
      ...
      <Modal isOpen={isOpen} onClose={onClose} size="md" isCentered>
        ...
        <ModalContent borderRadius="xl">
          ...
          <ModalFooter borderTop="1px solid" borderColor={useColorModeValue('gray.100', 'whiteAlpha.100')}>
